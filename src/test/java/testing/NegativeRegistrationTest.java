...
//
    ...
    public void negativeRegistrationTest() {
        ...
        Assert.assertEquals(pass2, "Заполните поле \"Пароль еще раз\"", LogForTest.info("Expected results of the empty \"second field pass\" - true (enter name, email, pass)"));

        String pass3 = negative.enterSecondPassField();
        Assert.assertEquals(pass3, "Заполните поле \"Пароль\"", LogForTest.info("Expected results of the empty \"first field pass\" - true (enter name, email, second field pass)"));
