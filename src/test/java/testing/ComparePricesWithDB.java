...
public class ComparePricesWithDB extends BasicTest {
    ...
    public void comparePrices(String product1, String product2) {
        ...
        mapList.put("Код: 65415-584885", "Intel Core i3-3250 LGA1155, 3.5GHz, Box (BX80637I33250SR0YX)");
        mapList.put("Код: 10347-917287", "Intel Core i5-4690K LGA1150, 3.5GHz, Box (BX80646I54690K)");
